...
档位：480p / 720p / 768p / 1080p；比例：1:1 / 3:4 / 4:3 / 16:9 / 9:16。
...
def main() -> int:
    # ---- 1. 档位与比例覆盖 ----
    check("档位集合 = {480, 720, 768, 1080}", _RES_TIERS == {480, 720, 768, 1080},
    ...
    check("错误提示列出全部四个档位",
          all(f"{t}p" in msg for t in (480, 720, 768, 1080)), f"msg={msg!r}")
